  ...
  [1],
  {
    ...
    QmWs: function(t, e, r) {
      ...
      function d(t, e, r) {
        ...
        var n = (t = t.trim()).match(f);
        (t = n ? y(n[1]).replace(/\\/g, '/') + n[2] : y(t).replace(/\\/g, '/')),
          v.test(t) && '/' !== t.slice(-1) && (t += '/');
        var a = !/(^javascript)/.test(t) && t.match(p),
          c = h.test(t),
          d = '';
        a &&
          (l.test(a[1]) || ((d = a[1].toLowerCase()), (t = '' + a[2] + a[3])),
          a[2] ||
            ((c = !1),
            l.test(a[1]) ? ((d = a[1]), (t = '' + a[3])) : (t = '//' + a[3])),
          (3 !== a[2].length && 1 !== a[2].length) ||
            ((d = a[1]), (t = '/' + a[3])));
        var m,
          g = t.match(/(:[0-9]+)/),
          b = '';
        g && g[1] && 3 === g[1].length && (t = t.replace((b = g[1]), b + '00'));
        var w = {},
          _ = '',
          x = '';
        try {
        ...
        (w.slashes = c && !x),
          (w.host = m.host === u ? '' : m.host),
          (w.hostname =
            m.hostname === u ? '' : m.hostname.replace(/(\[|\])/g, '')),
          (w.protocol = _ ? d || null : m.protocol),
          (w.search = m.search.replace(/\\/g, '%5C')),
          (w.hash = m.hash.replace(/\\/g, '%5C'));
        var S = t.split('#');
        !w.search && ~S[0].indexOf('?') && (w.search = '?'),
          w.hash || '' !== S[1] || (w.hash = '#'),
          (w.query = e ? o.decode(m.search.substr(1)) : w.search.substr(1)),
          (w.pathname = x + y(m.pathname).replace(/"/g, '%22')),
          'about:' === w.protocol &&
            'blank' === w.pathname &&
            ((w.protocol = ''), (w.pathname = '')),
          _ && '/' !== t[0] && (w.pathname = w.pathname.substr(1)),
          d &&
            !l.test(d) &&
            '/' !== t.slice(-1) &&
            '/' === w.pathname &&
          ...
          (w.href = x ? '' + w.pathname + w.search + w.hash : i(w));
      ...
      function b(t, e) {
        ...
        var u = new URL(t, s + '/'),
          l = new URL(e, u).toString().replace(s, ''),
          f = n.protocol || r.protocol;
        return (
          (f += r.slashes || n.slashes ? '//' : ''),
          !o && f ? (l = l.replace(c, f)) : o && (l = l.replace(c, '')),
          g.test(l) ||
            ~e.indexOf('.') ||
            '/' === t.slice(-1) ||
            '/' === e.slice(-1) ||
    ...
    elyg: function(t, e, r) {
      ...
      var g = (function() {
        function t(e, r, n, o) {
          ...
          a(this, t),
              ...
              if (t.state) {
                if (
                  (!t.state ||
                    !i.isSsr ||
                    t.state.as !== i.asPath ||
                    u.parse(t.state.url).pathname !== i.pathname) &&
                ...
                i.changeState(
                  'replaceState',
                  l.formatWithValidation({ pathname: a, query: c }),
                  l.getURL(),
                );
              }
            }),
            (this._getStaticData = function(t) {
              var e = d(u.parse(t).pathname);
              return i.sdc[e]
                ? Promise.resolve(i.sdc[e])
                : m(e, null, i.isSsr, function(t) {
                    return (i.sdc[e] = t);
                  });
            }),
            ...
            (this.query = r),
            (this.asPath =
              f.isDynamicRoute(e) && __NEXT_DATA__.autoExport ? e : n),
            (this.sub = b),
            (this.clc = null),
            (this._wrapApp = h),
            (this.isSsr = !0),
            ...
            this.changeState(
              'replaceState',
              l.formatWithValidation({ pathname: e, query: r }),
              n,
            ),
              ...
              },
              {
                ...
                value: function(e, r, n, o) {
                  ...
                  return new Promise(function(i, c) {
                    o._h || (a.isSsr = !1),
                      l.ST && performance.mark('routeChange');
                    var s =
                        'object' === typeof r ? l.formatWithValidation(r) : r,
                      d = 'object' === typeof n ? l.formatWithValidation(n) : n;
                    if (
                      (a.abortComponentLoad(d), !o._h && a.onlyAHashChange(d))
                    )
                      return (
                        (a.asPath = d),
                        t.events.emit('hashChangeStart', d),
                        a.changeState(e, s, v(d), o),
                        a.scrollToHash(d),
                        t.events.emit('hashChangeComplete', d),
                        i(!0)
                      );
                    var m = u.parse(s, !0),
                      g = m.pathname,
                      ...
                      w = m.protocol;
                    if (!g || w) return i(!1);
                    a.urlIsNew(d) || (e = 'replaceState');
                    var _ = y(g),
                      x = o.shallow,
                      S = void 0 !== x && x;
                    if (f.isDynamicRoute(_)) {
                      var P = u.parse(d).pathname,
                        O = h.getRouteRegex(_),
                        j = p.getRouteMatcher(O)(P);
                      if (j) Object.assign(b, j);
                      else if (
                    ...
                    t.events.emit('routeChangeStart', d),
                      a.getRouteInfo(_, g, b, d, S).then(function(r) {
                        var n = r.error;
                        if (n && n.cancelled) return i(!1);
                        if (
                          (t.events.emit('beforeHistoryChange', d),
                          a.changeState(e, s, v(d), o),
                          a.set(_, g, b, d, r),
                          n)
                        )
                          throw (t.events.emit('routeChangeError', n, d), n);
                        return t.events.emit('routeChangeComplete', d), i(!0);
                      }, c);
                  });
                },
              },
                        ...
                        switch ((i.prev = i.next)) {
                          case 0:
                            return (
                              ...
                              (i.next = 4),
                              n.awrap(this.pageLoader.loadPage(t))
                            );
                          case 4:
                            if (((o = i.sent), !e)) {
                              i.next = 9;
      ...
      (e.default = g), (g.events = s.default());
    },
    'g/15': function(t, e, r) {
      'use strict';
      var n = r('vJKn');
      ...
      (e.execOnce = function(t) {
        ...
        (e.getDisplayName = i),
        (e.isResSent = c),
        (e.loadGetInitialProps = function t(e, r) {
          var o, a, u;
          return n.async(
            function(s) {
              for (;;)
                switch ((s.prev = s.next)) {
                  ...
                  case 4:
                    ...
                    return (s.next = 9), n.awrap(t(r.Component, r.ctx));
                  case 9:
                    return (
                  ...
                  case 12:
                    return (s.next = 14), n.awrap(e.getInitialProps(r));
                  case 14:
                    if (((a = s.sent), !o || !c(o))) {
                      s.next = 17;
                      break;
