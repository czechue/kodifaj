...
function WithoutUserDataComponent(_ref) {
  ...
  return __jsx("section", {
    className: "w-full rounded text-sm shadow hover:shadow-md"
  }, __jsx("div", {
    className: "relative"
  }, __jsx("img", {
    className: "absolute h-16 w-16 object-cover rounded overflow-hidden shadow-md",
...
//# sourceMappingURL=[id].js.b29bdb2c5f8d4af7486c.hot-update.js.map