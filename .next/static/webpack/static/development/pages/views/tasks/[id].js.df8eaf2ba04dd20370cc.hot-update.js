...
function ContentComponent(_ref2) {
  ...
  function toggleSection(section) {
    setOpenedSections(function (prevState) {
      return _objectSpread({}, openSections, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])({}, section, prevState[section]));
    });
  }
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_7___default.a.Fragment, null, __jsx("section", null, __jsx(Heading, null, "Zadanie"), __jsx("p", null, content)), __jsx("section", {
    className: "mt-6"
  }, __jsx(Heading, null, "Twoje rozwi\u0105zanie"), __jsx("button", {
    onClick: function onClick() {
      return toggleSection(OpenableSections.SOLUTION);
    }
  }, "click"), openSections.solution && __jsx(_solution_form_solution_form_component__WEBPACK_IMPORTED_MODULE_9__["default"], {
    loading: loading,
    onSubmit: onSubmit
  })), __jsx("section", {
    className: "mt-6"
...
//# sourceMappingURL=[id].js.df8eaf2ba04dd20370cc.hot-update.js.map