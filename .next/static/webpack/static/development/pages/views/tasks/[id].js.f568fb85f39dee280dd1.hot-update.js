...
function ContentComponent(_ref2) {
  ...
  function toggleSection(section) {
    setOpenedSections(_objectSpread({}, openSections));
  }
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_7___default.a.Fragment, null, __jsx("section", null, __jsx(Heading, null, "Zadanie"), __jsx("p", null, content)), __jsx("section", {
    className: "mt-6"
  }, __jsx(Heading, null, "Twoje rozwi\u0105zanie"), __jsx(_solution_form_solution_form_component__WEBPACK_IMPORTED_MODULE_9__["default"], {
    loading: loading,
    onSubmit: onSubmit
  })), __jsx("section", {
    className: "mt-6"
...
//# sourceMappingURL=[id].js.f568fb85f39dee280dd1.hot-update.js.map