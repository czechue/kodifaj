      ...
      function FieldArrayComponent(_ref) {
        ...
        return __jsx(
          ...
          __jsx(
            ...
            {
              className:
                'mt-1 h-8 px-2 rounded-sm text-lg bg-gradient-button text-white text-white text-xs font-semibold',
              type: 'button',
              onClick: function onClick() {
                return fields.push(
                  Object(
...
//# sourceMappingURL=new.js.9b095df5278c8578f2b9.hot-update.js.map
