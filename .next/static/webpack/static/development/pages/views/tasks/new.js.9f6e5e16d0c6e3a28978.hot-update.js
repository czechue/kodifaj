      ...
      function FieldArrayComponent(_ref) {
        ...
        return __jsx(
          ...
          __jsx(
            ...
            {
              className:
                'mt-1 h-8 px-2 rounded-full text-lg bg-gradient-button text-white text-white text-xs font-semibold',
              type: 'button',
              onClick: function onClick() {
                return fields.push(
                  Object(
...
//# sourceMappingURL=new.js.9f6e5e16d0c6e3a28978.hot-update.js.map
