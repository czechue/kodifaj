(window.webpackJsonp = window.webpackJsonp || []).push([
  [4],
  {
    ...
    oF7s: function(t, e, a) {
      ...
      function w(t) {
        ...
        return f(
          ...
          f('span', { className: 'text-blue-300' }, 'Edit'),
        );
      }
      function g(t) {
        var e = t.task,
    ...
    yKmG: function(t, e, a) {
      ...
      var v = a('WxVa'),
        w = (a('Aio7'), i.a.createElement),
        g = function(t) {
          var e = t.tasks,
            a = Object(s.useContext)(u.a).user;
          return w(v.a, { user: a, withHero: !0 }, w(f, { tasks: e }));
        };
              ...
              switch ((a.prev = a.next)) {
                case 0:
                  return (
                    (a.prev = 0),
                    (a.next = 3),
                    r.a.awrap(l()(''.concat(o.a, '/api/tasks')))
                  );
                case 3:
