(window.webpackJsonp = window.webpackJsonp || []).push([
  [5],
  {
    ...
    yKmG: function(t, e, n) {
      ...
      var v = n('WxVa'),
        f = (n('Aio7'), i.a.createElement),
        g = function(t) {
          var e = t.tasks,
            n = Object(s.useContext)(u.a).user;
          return f(v.a, { user: n, withHero: !0 }, f(w, { tasks: e }));
        };
              ...
              switch ((n.prev = n.next)) {
                case 0:
                  return (
                    (n.prev = 0),
                    (n.next = 3),
                    r.a.awrap(o()(''.concat(c.a, '/api/tasks')))
                  );
                case 3:
                  return (t = n.sent), (n.next = 6), r.a.awrap(t.json());
                case 6:
                  return (e = n.sent), n.abrupt('return', { tasks: e });
                case 10:
                  return (
                    (n.prev = 10),
                    (n.t0 = n.catch(0)),
                    n.abrupt('return', { tasks: [] })
                  );
                case 13:
                case 'end':
                  return n.stop();
