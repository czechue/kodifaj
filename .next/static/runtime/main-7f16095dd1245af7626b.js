  ...
  [11],
  {
    '+oT+': function(e, t, r) {
      ...
      function a(e, t, r, a, o, u, i) {
        ...
        c.done ? t(s) : n.resolve(s).then(a, o);
      }
    ...
    IKlv: function(e, t, r) {
      ...
      var I = T.props,
        ...
        j = new k.DataManager(U);
      t.dataManager = j;
      var L = D || '';
      (r.p = L + '/_next/'),
        R.setConfig({ serverRuntimeConfig: {}, publicRuntimeConfig: q || {} });
      var B = (0, y.getURL)(),
        X = new x.default(O, L),
        G = function(e) {
          var t = s(e, 2),
      ...
      window.__NEXT_P && window.__NEXT_P.map(G),
        (window.__NEXT_P = []),
            ...
            o(t, [
              ...
              },
              {
                ...
                value: function() {
                  this.scrollToHash(),
                    ((T.nextExport &&
                      ((0, N.isDynamicRoute)(K.pathname) || location.search)) ||
                      (z.__NEXT_SPR && location.search)) &&
                      K.replace(
                        K.pathname +
                          '?' +
                          (0, C.stringify)(
                            (0, l.default)(
                              ...
                              K.query,
                              {},
                              (0, C.parse)(location.search.substr(1)),
                            ),
                          ),
                        B,
                        { _h: 1 },
              ...
              function(e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 26:
                      return (
                        (t.router = K = (0, E.createRouter)(S, A, B, {
                          initialProps: I,
                          pageLoader: X,
                          App: V,
                          Component: z,
            ...
            return n.wrap(function(e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  ...
                  case 3:
                    return (
                      console.error(o), (e.next = 7), X.loadPage('/_error')
                    );
                  case 7:
                    if (
                    ...
                    break;
                  case 14:
                    return (e.next = 16), (0, y.loadGetInitialProps)(a, i);
                  case 16:
                    e.t0 = e.sent;
                  case 17:
                    return (
      ...
      function ue() {
        y.SUPPORTS_PERFORMANCE_USER_TIMING &&
          ...
          W &&
            (performance.getEntriesByName('Next.js-hydration').forEach(W),
            performance.getEntriesByName('beforeRender').forEach(W)),
          ce());
      }
      function ie() {
        if (y.SUPPORTS_PERFORMANCE_USER_TIMING) {
      ...
      var fe = function(e) {
        return function(t) {
          var r = (0, l.default)({}, t, { Component: z, err: M, router: K });
          return v.default.createElement(
            se,
            null,
      ...
      function de() {
        return (de = (0, d.default)(
          n.mark(function e(t) {
            var r, a, o, u, i, c, s, f, p, d, m, g;
            return n.wrap(function(e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                  ...
                  case 8:
                    (a = a || F.Component),
                      ...
                      oe
                        ? (h.default.hydrate(n, E, ue), (oe = !1))
                        : h.default.render(n, E, ie),
                      W &&
                        y.SUPPORTS_PERFORMANCE_USER_TIMING &&
                        (PerformanceObserver in window
                          ? new PerformanceObserver(function(e) {
                              e.getEntries().forEach(W);
                            }).observe({ entryTypes: ['paint'] })
                          : window.addEventListener('load', function() {
                              performance.getEntriesByType('paint').forEach(W);
                            })),
