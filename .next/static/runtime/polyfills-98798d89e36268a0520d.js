        ...
        !(function() {
          ...
          R(R.S + R.F * !yt(function(t) {}), 'Array', {
            from: function(t) {
              var e,
                ...
                l = pt(i);
              if (
                (f && (c = P(c, a > 2 ? arguments[2] : void 0, 2)),
                null == l || (u == Array && at(l)))
              )
                for (n = new u((e = L(i.length))); e > s; s++)
                  ct(n, s, f ? c(i[s], s) : i[s]);
              else
          ...
          var wt = function(t, e) {
            ...
            At = c
              ...
              : function(t, e) {
                  u(t);
                  for (var n, r = Pt(e), o = r.length, i = 0; o > i; )
                    v.f(t, (n = r[i++]), e[n]);
                  return t;
                },
            Rt = r.document,
            ...
            Bt = function(t, e, n) {
              t &&
                !m((t = n ? t : t.prototype), Mt) &&
                Ut(t, Mt, { configurable: !0, value: e });
            },
            Ct = {};
                ...
                ('__proto__' in {}
                  ? (function(t, e, n) {
                      try {
                        (n = P(
                          Function.call,
                          fe.f(Object.prototype, '__proto__').set,
                          2,
                        ))(t, []),
          ...
          var We = ae.f,
            Ge = function(t) {
              return function(e) {
                for (
                  var n, r = gt(e), o = Pt(r), i = o.length, u = 0, a = [];
                  i > u;

                )
                  (n = o[u++]),
                    (c && !We.call(r, n)) || a.push(t ? [n, r[n]] : r[n]);
                return a;
              };
            },
            qe = Ge(!0);
          ...
          R(R.S, 'Object', {
            getOwnPropertyDescriptors: function(t) {
              for (
                var e, n, r = gt(t), o = fe.f, i = He(r), u = {}, a = 0;
                i.length > a;
          ...
          R(R.S + R.F * (en || nn), 'Reflect', {
            ...
            R(
              R.S +
                R.F *
                  a(function() {
                    Reflect.defineProperty(v.f({}, 1, { value: 1 }), 1, {
                      value: 2,
                    });
                  }),
              'Reflect',
          ...
          Vt('RegExp'),
            c &&
              'g' != /./g.flags &&
              v.f(RegExp.prototype, 'flags', { configurable: !0, get: fn });
          var _n = function(t) {
              return function(e, n) {
                var r,
                  o,
          ...
          var Fn = An;
          R(
            { target: 'RegExp', proto: !0, forced: Fn !== /./.exec },
            { exec: Fn },
          );
          var Tn = W('species'),
            kn = !a(function() {
            ...
            return [
              ...
              function(t) {
                ...
                for (var c, f = [], s = 0; null !== (c = jn(o, i)); ) {
                  var l = String(c[0]);
                  (f[s] = l),
                    '' === l && (o.lastIndex = En(i, L(o.lastIndex), a)),
                    s++;
                }
                return 0 === s ? null : f;
              },
            ...
            return [
              ...
              function(t, e) {
                ...
                for (var h = []; ; ) {
                  ...
                  if ((h.push(p), !s)) break;
                  '' === String(p[0]) &&
                    (a.lastIndex = En(c, L(a.lastIndex), l));
                }
                for (var d, v = '', y = 0, g = 0; g < h.length; g++) {
                  p = h[g];
                  for (
                    var b = String(p[0]),
                      m = Mn(Bn(N(p.index), c.length), 0),
                      w = [],
                      _ = 1;
                    _ < p.length;
                    _++
              ...
              [
                ...
                function(t, e) {
                  ...
                  for (var p = 0, d = 0, v = []; d < c.length; ) {
                    ...
                    if (
                      null === g ||
                      (y = Gn(L(l.lastIndex + ($n ? 0 : d)), c.length)) === p
                    )
                      d = En(c, d, s);
                    else {
            ...
            Un('search', 1, function(t, e, n, r) {
              return [
                ...
                function(t) {
                  ...
                  var c = jn(o, i);
                  return (
                    Ke(o.lastIndex, a) || (o.lastIndex = a),
                    null === c ? -1 : c.index
                  );
                },
              ];
          ...
          var Xn = { f: W },
            ...
            _r = function(t, e) {
              if (
                ((t = gt(t)), (e = p(e, !0)), t !== lr || !m(fr, e) || m(sr, e))
              ) {
                var n = Zn(t, e);
                return (
                  !n ||
            ...
            Er = function(t) {
              for (
                var e, n = t === lr, r = er(n ? sr : gt(t)), o = [], i = 0;
                r.length > i;
          ...
          hr ||
            (j(
              (nr = function() {
                ...
                return (
                  c && dr && vr(lr, t, { configurable: !0, set: e }), yr(t)
                );
              }).prototype,
              'toString',
              function() {
          ...
          function uo(t, e) {
            try {
              ...
              if (e && ('object' == typeof e || 'function' == typeof e)) {
                var n = e.then;
                if (e instanceof oo)
                  return (t._state = 3), (t._value = e), void co(t);
                if ('function' == typeof n)
                  return void so(
                    ((r = n),
                    (o = e),
          ...
          'Promise' in lo
            ? lo.Promise.prototype.finally ||
              (lo.Promise.prototype.finally = to)
            : (lo.Promise = oo);
          var ho = {
          ...
          if (ho.arrayBuffer)
            var po = [
              ...
              vo =
                ...
                function(t) {
                  return (
                    t && po.indexOf(Object.prototype.toString.call(t)) > -1
                  );
                };
          function yo(t) {
            if (
                ...
                (this._bodyInit = t),
                  t
                    ? 'string' == typeof t
                      ...
                      : ho.arrayBuffer &&
                        (ArrayBuffer.prototype.isPrototypeOf(t) || vo(t))
          ...
          (mo.prototype.append = function(t, e) {
            ...
            ho.iterable &&
              (mo.prototype[Symbol.iterator] = mo.prototype.entries);
          ...
          function Fo(t, e) {
            return new Promise(function(n, r) {
              ...
              if (o.signal && o.signal.aborted)
                return r(new Io('Aborted', 'AbortError'));
                  ...
                  var o = function(t) {
                      ...
                      if ('undefined' === e);
                        ...
                        if (
                          ...
                          for (var u in t)
                            t.hasOwnProperty(u) && this.append(u, t[u]);
                      }
                    },
                    i = o.prototype;
