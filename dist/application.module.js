...
const faq_render_controller_1 = require('./routes/faq-render.controller');
const login_render_controller_1 = require('./routes/login-render.controller');
    ...
    [
      common_1.Module({
        ...
        controllers: [
          ...
          faq_render_controller_1.FaqRenderController,
          login_render_controller_1.LoginRenderController,
        ],
      }),
    ],
    AppModule,
