...
exports.UsersRenderController = void 0;
const common_1 = require('@nestjs/common');
let UsersRenderController = /** @class */ (() => {
  let UsersRenderController = class UsersRenderController {
    users() {}
    user(id) {
      return { id };
    }
  ...
  __decorate(
    ...
    UsersRenderController.prototype,
    'users',
    null,
  );
  __decorate(
